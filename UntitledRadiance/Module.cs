...
{
    protected readonly UntitledRadiance untitledRadiance_;
    protected readonly Dictionary<string, object> prefabs = new();
    protected readonly System.Random random = new();
    public Module(UntitledRadiance untitledRadiance)
    {
        untitledRadiance_ = untitledRadiance;
        untitledRadiance_.modules.Add(this);
    }
    protected void Log(object message) => untitledRadiance_.Log(message);
